...
<header class="header {scrolled ? 'scrolled' : ''}">
    ...
    <div class="actions">
        <div class="flex flex-row gap-3 items-center">
            <a href="https://tinyurl.com/Datankoaa" target="_blank" class="flex items-center px-4 py-1.5 rounded-lg backdrop-blur-md bg-[#121063]/5 hover:bg-[#121063]/10 border border-[#121063]/10 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-sm text-[#121063]" aria-label="Get it on Google Play">
            ...
            <div class="flex items-center px-4 py-1.5 rounded-lg backdrop-blur-md bg-[#121063]/5 border border-[#121063]/5 opacity-50 cursor-default text-[#121063] relative transition-all duration-300" aria-label="App Store - Coming Soon">
                ...
                <div class="flex flex-col items-start leading-tight">
                    <span class="text-[8px] uppercase font-bold tracking-[0.05em] opacity-80">Download on the</span>
                    <span class="text-sm font-bold tracking-tight">App Store</span>
                </div>
                <span class="absolute inset-0 flex items-center justify-center text-white text-[9px] font-bold uppercase tracking-widest rounded-lg bg-black/60 backdrop-blur-[2px]">Soon</span>
            </div>
        </div>
    </div>
