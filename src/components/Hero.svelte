...
<section id="hero" class="hero_fullscreen">
    ...
    <div class="content" use:reveal={{type: 'fadeInUp'}}>
        ...
        <div class="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center w-full sm:w-auto">
            ...
            <div class="flex items-center px-5 py-2.5 rounded-xl backdrop-blur-md bg-white/5 border border-white/10 opacity-60 cursor-default text-white relative transition-all duration-300" aria-label="App Store - Coming Soon">
                ...
                <div class="flex flex-col items-start leading-tight">
                    <span class="text-[10px] uppercase font-medium tracking-[0.05em] mb-0.5 opacity-80">Download on the</span>
                    <span class="text-lg font-semibold tracking-tight">App Store</span>
                </div>
                <span class="absolute inset-0 flex items-center justify-center text-white text-[11px] font-bold uppercase tracking-widest rounded-xl bg-black/60 backdrop-blur-sm">Coming Soon</span>
            </div>
        </div>
    </div>
